...
public class WconceptExchangeDataTest {

    @Test
    public void run(){
        File TargetHtml = new File("C:\\project\\argo_server_dev\\argo-collector\\src\\test\\java\\com\\argo\\collect\\domain\\data\\wconceptExchange.html");
        Document doc = null;
        try {
