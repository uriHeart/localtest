...
public class PlayerOrderAddressConversionTemplate {
    ...
    private static List<ConversionRule> getConversionRuleForOrderAddress() {
        ...
        list.add(ConversionRule.builder()
                ...
                .conversionTemplateSourceId("1-OriginalAddress")
        ...
        list.add(ConversionRule.builder()
                .conversionType(ConversionType.CONVERSION_TEMPLATE)
                .targetField("orderer")
                .conversionTemplateSourceId("1-Orderer")
        ...
        list.add(ConversionRule.builder()
                ...
                .conversionTemplateSourceId("1-Recipient")
        ...
        list.add(ConversionRule.builder()
                ...
                .conversionTemplateSourceId("1-DeliveryRequest")
