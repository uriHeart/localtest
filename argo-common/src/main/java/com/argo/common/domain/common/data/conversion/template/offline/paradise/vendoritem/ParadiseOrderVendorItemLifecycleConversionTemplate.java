package com.argo.common.domain.common.data.conversion.template.offline.paradise.vendoritem;
...
public class ParadiseOrderVendorItemLifecycleConversionTemplate {
    ...
    private static List<ConversionRule> getConversionRuleForOrderVendorItemLifecycle() {
        ...
        list.add(ConversionRule.builder()
                ...
                .conversionTemplateSourceId("20-ORDER-OrderVendorItemMetadata")
