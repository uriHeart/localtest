        ...
        return OrderResultDto.builder()
                ...
                .orderProduct(OrderProductDto.builder()
                        ...
                        .productPrice(ProductPriceDto.builder()
                                .originalPrice(vendorItem.getOrderVendorItemMetadata().getOriginalPrice())
                                .salesPrice(vendorItem.getOrderVendorItemMetadata().getSalesPrice())
                                .paymentMethod(vendorItem.getOrderVendorItemMetadata().getPaymentMethod())
                                .paymentAmount(vendorItem.getOrderVendorItemMetadata().getPaymentAmount())
                                .build())
                        .build())
                .build();
    }
